...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='stockitem',
            name='parent',
            field=mptt.fields.TreeForeignKey(blank=True, help_text='Link to another StockItem from which this StockItem was created', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='children', to='stock.stockitem', verbose_name='Parent Stock Item'),
        ),
        migrations.AddField(
            model_name='stockitem',
            name='purchase_order',
            field=models.ForeignKey(blank=True, help_text='Link to a PurchaseOrder (if this stock item was created from a PurchaseOrder)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='stock_items', to='orders.purchaseorder', verbose_name='Source Purchase Order'),
        ),
        migrations.AddField(
            model_name='stockitem',
            name='sales_order',
            field=models.ForeignKey(blank=True, help_text='Link   item to a SalesOrder', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='stock_items', to='orders.salesorder', verbose_name='Destination Sales Order'),
        ),
        migrations.AddField(
            model_name='stockitem',
            name='stocktaker',
            field=models.ForeignKey(blank=True, help_text='User that performed the most recent stocktake', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='stocktakes', to=settings.AUTH_USER_MODEL),
        ),
    ]
