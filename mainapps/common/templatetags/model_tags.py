...
def model_list(user):
    apps_list=[]
    exp_excluded_apps=['admin','auth','contenttypes','management','cities_light','accounts','sessions','messages','staticfiles','content_type_linking_models','permit','widget_tweaks','bootstrap5']
    excluded_apps=['admin','auth','contenttypes','management','accounts','common','sessions','messages','staticfiles','content_type_linking_models','permit','widget_tweaks','bootstrap5']
    for app in apps.get_app_configs():
